...
[PR #7] (https://github.com/fivetran/dbt_qualtrics_source/pull/7) includes the following updates: 

## Bug Fix
- Update unique columns test on stg_qualtrics__distribution_contact to include contact_lookup_id 
