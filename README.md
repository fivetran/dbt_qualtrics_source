# [DEPRECATED] Qualtrics Source dbt Package

> _This package has been archived and is no longer maintained. Use [`dbt_qualtrics`](https://github.com/fivetran/dbt_qualtrics) instead, which now contains all models previously found here._
...
- If you have questions or want to reach out for help, see the [GitHub Issue](https://github.com/fivetran/dbt_qualtrics_source/issues/new/choose) section to find the right avenue of support for you.
